...
export default function WeeklyProgress({
  ...
  return (
    <div className={`rounded-xl border border-zinc-200 bg-white p-6 shadow-sm ${className}`}>
      ...
      {/* KPIs — 3 cards with prominent numbers */}
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
        {/* Workouts Completed */}
        <div className="flex flex-col gap-2 rounded-xl border border-zinc-100 bg-zinc-50 p-5">
          <span
            className="flex h-10 w-10 items-center justify-center rounded-lg bg-white shadow-sm"
            aria-hidden="true"
          >
            <NavIcon name="workout-complete.svg" className="h-5 w-5 text-success" />
          </span>
