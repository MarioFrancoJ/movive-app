...
function KpiCard({
  ...
  return (
    <div className="flex items-center gap-3 rounded-golden-lg border border-zinc-200 bg-white px-4 py-4 shadow-sm">
      ...
      <div className="min-w-0 flex-1">
        ...
        <p className="mt-golden-1 truncate text-golden-lg font-bold text-zinc-900">
          {value}
        </p>
...
export default function WeeklyProgress({
  ...
  return (
    <div className={`rounded-xl border border-zinc-200 bg-white p-6 shadow-sm ${className}`}>
      ...
      {/* KPIs — 3 cards with horizontal layout */}
      <div className="grid grid-cols-1 gap-3 sm:grid-cols-3">
        <KpiCard
          icon={<NavIcon name="workout-complete.svg" className="h-6 w-6 text-success" />}
        ...
        <KpiCard
          icon={
            <svg viewBox="0 0 20 20" fill="currentColor" className="h-6 w-6 text-blue-600">
        ...
        <KpiCard
          icon={
            <svg viewBox="0 0 20 20" fill="currentColor" className="h-6 w-6 text-orange-500">
